...
<input type="text" name="search-articles" class="after-input" placeholder="Search articles"/>
  ...
  <table class="table table-hover table-striped table-bordered responsive articles-view-table">
    <thead class="should-be-sortable">
      <tr>
        ...
        <th id="articleHeaderId" align="top" class="modal-cat2">Id</th>
        <th id="articleHeaderTitle" align="top" class="modal-cat2">Title</th>
        <th id="articleHeaderContent" align="top" class="modal-cat2">Content</th>
      </tr>
    </thead>
